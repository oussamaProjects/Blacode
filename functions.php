<?php
/**
 * Blacode functions and definitions
 *
...
if ( ! function_exists( 'blacode_setup' ) ) :
	/**
	 ...
	 */
	function blacode_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Blacode, use a find and replace
		 * to change 'blacode' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'blacode', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'blacode' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'blacode_custom_background_args', array(
...
add_action( 'after_setup_theme', 'blacode_setup' );
 ...
 */
function blacode_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'blacode_content_width', 640 );
}
add_action( 'after_setup_theme', 'blacode_content_width', 0 );
 ...
 */
function blacode_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'blacode' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'blacode' ),
...
add_action( 'widgets_init', 'blacode_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'blacode_scripts' );
